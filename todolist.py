...
task_entry.focus()
button=Button(frame,text="ADD",font="arial 20 bold",width=6,bg="white",fg="Black",bd=0,command=addTask)
button.place(x=300,y=0)
frame1=Frame(root,bd=3,width=700,height=280,bg="black")
frame1.pack(pady=(160,0))
listbox=Listbox(frame1,font=("arial",12),width=40,height=16,bg="#32405b",fg="white",cursor="hand2",selectbackground="black")
